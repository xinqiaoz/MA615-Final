...
knitr::opts_chunk$set(echo = FALSE, warning=FALSE, message=FALSE,  out.width="0.9\\linewidth",dev="pdf",fig.align  = 'center')
pacman::p_load(
  "tidyverse",
  "ggplot2", 
  "httr", 
...
This is the data I intended to add into the study. This website(referred at last) provides numeric values of ranges of different models of electric vehicles. I feel like it would be interesting to add it into the study. However, I did not find a good place to fit in this idea.   
On the other hand, they do not provide any csv download portal or url to extract. Thus I manually picked ten popular models just for fun.  
```{r}
model<- c("Tesla CyberTruck Tri Motor", "Tesla Model S Long Range", "Tesla Model S Performance", "Tesla Model X Long Range", "Jaguar I-Pace", "Porsche Taycan 4S", "Audi e-tron Sportback 50 quattro", "Honda e", "Mercedes EQA", "BMW iX3")
range<- c(750, 525, 510, 460, 370, 355, 290, 200, 350, 350)
EV<- data.frame(Model=model, Range=range)
```
